...
namespace Drupal\department_access\Form;
...
final class DepartmentAccessSettingsForm extends ConfigFormBase {
  ...
  public static function create(ContainerInterface $container): static {
    ...
    $instance->roleEnsurer = $container->get('department_access.role_ensurer');
    $instance->folderSync = $container->get('department_access.folder_sync');
    return $instance;
  }
  ...
  public function getFormId(): string {
    return 'department_access_settings';
  }
  ...
  protected function getEditableConfigNames(): array {
    return ['department_access.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    $config = $this->config('department_access.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $this->config('department_access.settings')
