...
final class DepartmentResolver {
  ...
  public function getDepartments(): array {
    $list = $this->configFactory->get('hkcec_department_access.settings')->get('departments') ?? [];
    $out = [];
    foreach ($list as $row) {
  ...
  public function getPrimaryDepartmentId(AccountInterface $account): ?string {
    ...
    $priority = $this->configFactory->get('hkcec_department_access.settings')->get('primary_department_priority') ?? [];
