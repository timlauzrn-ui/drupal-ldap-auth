...
namespace Drupal\Tests\hkcec_department_access\Unit;

use Drupal\Core\Config\ConfigFactoryInterface;
use Drupal\Core\Config\ImmutableConfig;
use Drupal\Core\Entity\EntityTypeManagerInterface;
use Drupal\Core\Session\AccountInterface;
use Drupal\hkcec_department_access\Service\DepartmentResolver;
use Drupal\Tests\UnitTestCase;

/**
 * @coversDefaultClass \Drupal\hkcec_department_access\Service\DepartmentResolver
 * @group hkcec_department_access
 */
final class DepartmentResolverTest extends UnitTestCase {
  ...
  public function testPrimaryDepartmentFromPriority(): void {
    ...
    $factory->method('get')->with('hkcec_department_access.settings')->willReturn($settings);
