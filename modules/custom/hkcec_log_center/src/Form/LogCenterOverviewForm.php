...
namespace Drupal\hkcec_log_center\Form;
...
use Drupal\Core\Url;
use Drupal\hkcec_log_center\Service\LogCenterQuery;
...
final class LogCenterOverviewForm extends FormBase {
  ...
  public static function create(ContainerInterface $container): static {
    return new static(
      $container->get('hkcec_log_center.query'),
  ...
  public function getFormId(): string {
    return 'hkcec_log_center_overview_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $form['filters']['actions'] = [
      ...
      'export' => [
        ...
        '#url' => Url::fromRoute('hkcec_log_center.export', [], [
          'query' => array_filter([
      ...
      $rows[] = [
        ...
        'ops' => [
          'data' => [
            '#type' => 'link',
            '#title' => $this->t('View'),
            '#url' => Url::fromRoute('hkcec_log_center.detail', ['log_id' => $row->id]),
          ],
        ],
      ];
    }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $form_state->setRedirect('hkcec_log_center.overview', [], [
  ...
  private function sortHeader(string $label, string $field, string $current_sort, string $current_order): array {
    ...
    return [
      'data' => [
        ...
        '#url' => Url::fromRoute('hkcec_log_center.overview', [], ['query' => $query]),
      ],
    ];
  }
