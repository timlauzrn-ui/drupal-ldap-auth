...
final class LogCenterSettingsForm extends ConfigFormBase {
  ...
  public function getFormId(): string {
    return 'hkcec_log_center_settings_form';
  }
  ...
  protected function getEditableConfigNames(): array {
    return ['hkcec_log_center.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    $config = $this->config('hkcec_log_center.settings');
    $form['access_logging'] = [
      '#type' => 'checkbox',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $this->config('hkcec_log_center.settings')
