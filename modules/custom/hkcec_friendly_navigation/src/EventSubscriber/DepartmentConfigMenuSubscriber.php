...
namespace Drupal\hkcec_friendly_navigation\EventSubscriber;

use Drupal\Core\Config\ConfigCrudEvent;
use Drupal\Core\Config\ConfigEvents;
use Drupal\hkcec_friendly_navigation\Service\DepartmentMenuSync;
use Symfony\Component\EventDispatcher\EventSubscriberInterface;

/**
 * Re-sync department menus when hkcec_department_access settings change.
 */
