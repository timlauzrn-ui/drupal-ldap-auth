...
namespace Drupal\hkcec_ldap_role_mapper\Form;
...
final class LdapRoleMapperSettingsForm extends ConfigFormBase {
  ...
  public function getFormId(): string {
    return 'hkcec_ldap_role_mapper_settings';
  }
  ...
  protected function getEditableConfigNames(): array {
    return ['hkcec_ldap_role_mapper.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    $config = $this->config('hkcec_ldap_role_mapper.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $this->config('hkcec_ldap_role_mapper.settings')
