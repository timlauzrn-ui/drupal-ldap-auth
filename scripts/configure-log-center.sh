...
SRC="${PROJECT_ROOT}/modules/custom/log_center"
DEST="/opt/drupal/web/modules/custom/log_center"
...
docker exec -u www-data -w /opt/drupal "${CONTAINER}" vendor/bin/drush en log_center -y
